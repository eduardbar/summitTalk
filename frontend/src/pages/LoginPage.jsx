...
import { Eye, EyeOff, Loader2, Lock, Mail, MessageSquare, AppWindow } from "lucide-react";
      ...
      <div className="flex flex-col justify-center items-center p-6 sm:p-12 w-full max-w-md space-y-8">
        ...
        <div className="text-center mb-8">
          <div className="flex flex-col items-center gap-2 group">
            ...
            <p className="text-base-content/60">Inicia Sesión para continuar con tus conversaciones</p>
          </div>
        </div>
